...
// siehe auch die Anwendung eines Thread
...
public class DemoProgressMonitor extends JPanel implements ActionListener {
	 ...
	 */
	public void actionPerformed(ActionEvent evt) {
		progressMonitor = new ProgressMonitor(DemoProgressMonitor.this, "Running a Long Task", "", 0, 100); // task.getLengthOfTask());
	...
	// JComponent newContentPane = new DemoProgressMonitor();
